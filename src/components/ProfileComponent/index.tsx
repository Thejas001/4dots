...
<div className=" grid grid-rows-[auto,1fr]  bg-[#fff] h-full">
  ...
  <div onClick={handleLogout} className="flex items-center rounded-[28px] border border-[#B5B5B5] bg-[#ECECEC] gap-2 px-3 py-1.5 cursor-pointer">
    <span>
        ...
        <path d="M13.496 21H6.5C5.395 21 4.5 19.849 4.5 18.429V5.57C4.5 4.151 5.395 3 6.5 3H13.5M16 15.5L19.5 12L16 8.5M9.5 11.996H19.5" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </span>
