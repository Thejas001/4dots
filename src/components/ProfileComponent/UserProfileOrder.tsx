              ...
              order.Items.map((item) => (
                <div key={item.OrderItemId} className="border rounded-md p-4">
                  <div className="flex">
                    ...
                    <div className="bg-lightgray h-[131px] w-[131px] rounded-md border border-[#ECECEC] bg-cover bg-center bg-no-repeat object-cover self-center sm:self-start overflow-hidden">
                      {(() => {
