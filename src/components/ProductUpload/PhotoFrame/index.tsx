            ...
            <div className="p-8 bg-white overflow-y-auto h-screen hide-scrollbar xl:col-span-3">
              <div className="max-w-5xl mx-auto">
                ...
                <div className="space-y-4">
                  ...
                  {/* Step 3: Size Selection - Only show after quantity is entered */}
                  {showSizeSelection && selectedQuantity && selectedQuantity > 0 && (
                    <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  {showFrameColorSelection && selectedSize && (
                    <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  {selectedSize && selectedFrameColor && (
