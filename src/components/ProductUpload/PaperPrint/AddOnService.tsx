  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-xl p-6">
        ...
        {copySelection && (
          <button
            onClick={() => setShowBindingOptions(true)}
            className="mt-4 w-full py-3 px-6 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition-all duration-200"
          >
            Continue to Binding Type
          </button>
        )}
      </div>
      ...
      {showBindingOptions && (
        <div className="bg-gray-50 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => setShowBindingOptions(false)}
