                      ...
                      <div className={`relative flex h-[24px] w-[24px] sm:h-[30px] sm:w-[30px] items-center justify-center rounded-full border ${order.OrderStatus === "Completed" || order.OrderStatus === "COD" || order.OrderStatus === "PaymentSuccessful" || order.OrderStatus === "Shipped" || order.OrderStatus === "InProgress" || order.OrderStatus === "Delivered" ? "border-[#000]" : "border-gray-300"} transition duration-500 ease-in-out`}>
                        ...
                        >
                          <path
                            ...
                            fill={ order.OrderStatus === "COD" || order.OrderStatus === "Completed" || order.OrderStatus === "PaymentSuccessful" ||   order.OrderStatus === "Shipped"  || order.OrderStatus === "InProgress" || order.OrderStatus === "Delivered" ? "black" : "#B5B5B5"}
                          />
                          <path
                            ...
                            stroke={order.OrderStatus === "COD" || order.OrderStatus === "Completed" ||  order.OrderStatus === "PaymentSuccessful" ||  order.OrderStatus === "Shipped" ||order.OrderStatus === "InProgress" || order.OrderStatus === "Delivered" ? "black" : "#B5B5B5"}
                            strokeWidth="0.5"
                          />
                        </svg>
                      ...
                      <div className={` relative flex h-[24px] w-[24px] sm:h-[30px] sm:w-[30px] items-center justify-center rounded-full border ${order.OrderStatus === "Shipped" || order.OrderStatus === "Completed" ||order.OrderStatus === "InProgress" || order.OrderStatus === "Delivered" ? "border-[#000]" : "border-gray-300"} transition duration-500 ease-in-out`}>
                        ...
                        >
                          <path
                            ...
                            stroke={order.OrderStatus === "Shipped" || order.OrderStatus === "Completed" ||  order.OrderStatus === "InProgress" || order.OrderStatus === "Delivered" ? "black" : "#B5B5B5"}
                          ...
                          <path
                            ...
                            stroke={order.OrderStatus === "InProgress" || order.OrderStatus === "Completed" || order.OrderStatus === "Delivered"||order.OrderStatus === "Shipped"  ? "black" : "#B5B5B5"}
                            strokeWidth="0.731707"
                            strokeLinejoin="round"
                          />
                          <path
                      ...
                      <div className={`relative flex h-[24px] w-[24px] sm:h-[30px] sm:w-[30px] items-center justify-center rounded-full border
                        ...
                        >
                          <path
                            ...
                            stroke={order.OrderStatus === "Shipped" || order.OrderStatus === "Completed" || order.OrderStatus === "Delivered"  ? "black" : "#B5B5B5"}
                            strokeWidth="1.09756"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
