                ...
                <div className="w-full ">
                  ...
                  <div className="mx-4  flex items-center">
                    ...
                    <div className=" ml-5 mr-1.5 flex flex-col items-center">
                      <div className="relative flex h-[30px] w-[30px] items-center justify-center rounded-full border border-[#000] transition duration-500 ease-in-out">
                        <svg
                        ...
                        <div className="absolute top-10 w-32  text-center text-sm font-normal leading-6 tracking-[-0.2px] text-[#242424]">
                          Order Placed
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Divider */}
                    <div className=" w-[181px] border border-[#242424]"></div>
                    ...
                    {/* Order Shipped */}
                    <div className=" ml-1.5 mr-1.5 flex flex-col items-center text-gray-400">
                      <div className="relative flex h-[30px] w-[30px] items-center justify-center rounded-full border border-gray-300 transition duration-500 ease-in-out">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="19"
                          height="19"
                        ...
                        <div className="absolute top-10 w-32  text-center text-sm font-normal leading-6 tracking-[-0.2px] text-[#B5B5B5] ">
                          Order Shipped
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Order Shipped */}
                    <div className=" ml-1.5 flex flex-col items-center text-gray-400">
                      <div className="relative flex h-[30px] w-[30px] items-center justify-center rounded-full border border-gray-300 transition duration-500 ease-in-out">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
