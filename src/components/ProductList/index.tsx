    ...
    <>
      ...
      <div className="hidden md:grid grid-cols-12 gap-[7px] bg-[#fcfcfc] px-[25px] md:gap-6 md:px-20">
        <div className="col-span-12 flex items-center justify-center pb-1 pt-[27px] text-xl font-medium  text-[#242424]">
         ...
         <div 
           data-id="2" 
           className="relative col-span-7 h-[186px] overflow-hidden rounded-[7.137px] transition-shadow duration-300 hover:shadow-lg md:h-[522px] md:rounded-[20px] lg:col-span-5 cursor-pointer"
           onClick={() => router.push("/ProductDetails/photo-frame?dataId=2")}
         > 
           <img
             src="/images/product/photoframe.jpg"
             alt="Photo Frames"
           ...
           <button 
             onClick={(e) => {
               e.stopPropagation();
               router.push("/ProductDetails/photo-frame?dataId=2");
             }}
             className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
           >
               <span className="flex items-center">
         ...
         <div data-id="1" className="col-span-5 grid h-[186px] grid-rows-2 gap-2 overflow-hidden md:h-[522px] md:gap-6 lg:col-span-3">
           <div 
             className="relative col-span-12 overflow-hidden rounded-[7.137px] transition-shadow duration-300 hover:shadow-lg md:rounded-[20px] cursor-pointer"
             onClick={() => router.push("/ProductDetails/paper-print?dataId=1")}
           >
             <img
               src="/images/product/paperprint.jpg"
               alt=""
             ...
             <button 
               onClick={(e) => {
                 e.stopPropagation();
                 router.push("/ProductDetails/paper-print?dataId=1");
               }}
               className="absolute bottom-0 right-0 flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
             >
                   <span className="flex items-center">
                     Starting From @
                      <span className="flex items-center">
           ...
           <div 
             data-id="3" 
             className="relative col-span-12 overflow-hidden rounded-[7.137px] transition-shadow duration-300 hover:shadow-lg md:rounded-[20px] cursor-pointer"
             onClick={() => router.push("/ProductDetails/business-card?dataId=3")}
           >
             <img
               src="images/product/bussinesscard.jpg"
               loading="eager"
             ...
             <button 
               onClick={(e) => {
                 e.stopPropagation();
                 router.push("/ProductDetails/business-card?dataId=3");
               }}
               className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
             >
                 <span className="flex items-center">
         ...
         <div 
           data-id="5" 
           className="relative col-span-4 h-[163.729px] overflow-hidden rounded-[6.017px] bg-blue-300 transition-shadow duration-300 hover:shadow-lg md:h-[522px] md:rounded-[20px] lg:col-span-4 cursor-pointer"
           onClick={() => router.push("/ProductDetails/offset-printing?dataId=5")}
         >
           <img
             src="/images/product/Flyer.jpg"
             loading="eager"
           ...
           {getProductDetails(5) ? "Bulk Flyers" : "Loading..."}
             ...
             <button 
               onClick={(e) => {
                 e.stopPropagation();
                 router.push("/ProductDetails/offset-printing?dataId=5");
               }}
               className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
             >
                 <span className="flex items-center">
         ...
         <div data-id="4" className="col-span-8 grid grid-cols-12 gap-2 md:gap-6 lg:col-span-12">
           <div 
             className="relative col-span-12 h-[78.525px] overflow-hidden rounded-[8.541px] bg-pink-300 transition-shadow duration-300 hover:shadow-lg sm:h-[249px] md:rounded-[20px] lg:col-span-8 cursor-pointer"
             onClick={() => router.push("/ProductDetails/letter-head?dataId=4")}
           >
             <img
               src="/images/product/letterhead.jpg"
               loading="eager"
             ...
             {getProductDetails(4)?.name || "Loading..."}
               ...
               <button 
                 onClick={(e) => {
                   e.stopPropagation();
                   router.push("/ProductDetails/letter-head?dataId=4");
                 }}
                 className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
               >
                 <span className="flex items-center">
           ...
           <div 
             data-id="6" 
             className="relative col-span-12 h-[79px] overflow-hidden rounded-[8.541px] bg-blue-300 transition-shadow duration-300 hover:shadow-lg sm:h-[249px] md:rounded-[20px] lg:col-span-4 cursor-pointer"
             onClick={() => router.push("/ProductDetails/canvas-printing?dataId=6")}
           >
             <img
               src="/images/product/canvas.jpg"
               loading="eager"
             ...
             {getProductDetails(6)?.name || "Loading..."}
               ...
               <button 
                 onClick={(e) => {
                   e.stopPropagation();
                   router.push("/ProductDetails/canvas-printing?dataId=6");
                 }}
                 className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
               >
                 <span className="flex items-center">
         ...
         <div 
           data-id="7" 
           className="relative col-span-6 h-[139.226px] overflow-hidden rounded-[8.541px] bg-pink-300 transition-shadow duration-300 hover:shadow-lg sm:h-[326px] md:rounded-[20px] lg:col-span-6 cursor-pointer"
           onClick={() => router.push("/ProductDetails/polaroid-card?dataId=7")}
         >
           <img
             src="/images/product/polaroidnew.png"
             alt=""
           ...
           {getProductDetails(7)?.name || "Loading..."}
             ...
             <button 
               onClick={(e) => {
                 e.stopPropagation();
                 router.push("/ProductDetails/polaroid-card?dataId=7");
               }}
               className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
             >
                 <span className="flex items-center">
         ...
         <div 
           data-id="8" 
           className="relative col-span-6 h-[139.226px] overflow-hidden rounded-[8.541px] bg-blue-300 transition-shadow duration-300 hover:shadow-lg sm:h-[326px] md:rounded-[20px] lg:col-span-6 cursor-pointer"
           onClick={() => router.push("/ProductDetails/custom-name-slip?dataId=8")}
         >
           <img
             src="/images/product/nameslip1.jpg"
             alt=""
           ...
           {getProductDetails(8)?.name || "Loading..."}
             ...
             <button 
               onClick={(e) => {
                 e.stopPropagation();
                 router.push("/ProductDetails/custom-name-slip?dataId=8");
               }}
               className="absolute bottom-[7.13px] right-[7.27px] flex items-center rounded-full border border-white bg-black bg-opacity-50 px-2 text-[8px] font-medium tracking-[0.096px] text-white transition duration-300 md:bottom-[25px] md:right-8.5 md:p-2.5 md:text-base"
             >
                 <span className="flex items-center">
