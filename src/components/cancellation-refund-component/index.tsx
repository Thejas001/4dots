      ...
      <section className="pt-10 pb-16 text-center">
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
            Cancellation & <span className="text-blue-500">Refund</span>
          </h1>
            ...
            <div className="py-12 px-6 flex items-start gap-6 max-w-4xl mx-auto text-left ">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-2">
                  If you have any questions about these Cancellation & Refund Policy, please contact us :
                </p>
