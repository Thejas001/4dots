      ...
      <section className="px-0 pt-16 pb-20 mx-0">
        <div className="w-full text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
            Cancellation <span className="text-red-500">&</span> Refund
          </h1>
          <p className="text-xl text-gray-700 mb-10">
            Our transparent policies for order modifications
          </p>
      ...
      <section className="px-0 pb-32 mx-0">
        <div className="w-full border-t border-b border-black">
          ...
          <div className="py-12 text-center border-b border-black">
            <h2 className="text-3xl font-bold mb-4 tracking-tight">Refund Policy Framework</h2>
            <div className="w-24 h-0.5 bg-black mx-auto mb-6"></div>
            <p className="text-gray-700">
              Comprehensive guidelines for order modifications
            </p>
          </div>
              ...
              <div className="w-full flex flex-col md:flex-row gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Custom printed nameslips cannot be cancelled or refunded once production commences due to their personalized nature.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="w-full flex flex-col md:flex-row gap-8">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-4 flex items-center gap-3">
                    ...
                    Damage Resolution Protocol
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    For items damaged in transit or due to manufacturing defects: We require photographic evidence within 24 hours of delivery receipt.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="w-full flex flex-col md:flex-row gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <p className="text-gray-700 leading-relaxed">
                      Our dedicated resolution team is available through multiple channels:
                    </p>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <a href="https://wa.me/919037611189" className="font-medium hover:underline">+91 9037611189</a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="py-12 px-0 text-center">
            <div className="w-full text-center">
              <div className="inline-flex items-center gap-3 mb-5">
                ...
                <span className="text-sm font-medium tracking-wider">LEGAL DISCLAIMER</span>
              </div>
              <p className="text-gray-700 leading-relaxed">
                By proceeding with your order, you acknowledge and consent to these terms. We reserve the right to modify these policies with 30 days notice.
              </p>
            </div>
          </div>
        </div>
